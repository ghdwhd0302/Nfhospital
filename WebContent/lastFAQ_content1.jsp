...
<head>
    ...
    <link rel="stylesheet" href="asset/css/lastFAQ_content1.css">
        ...
        <main id="content" class="rsvContent replaceUtilMenu">
            ...
            <div class="boardView">
                ...
                <div class="viewTitle">
                    ...
                    <div class="date">
                        조회수 : 1975
                        <span class="">작성일 : 2017-08-18</span>
                    </div>
                ...
                <div class="viewContent">
                    ...
                    <p></p><p>월요일과 휴일 다음날은 통화량이 아주 많아 통화가 되지 않는 경우가 많이 있습니다.&nbsp;</p> 
        <p>가급적 오후시간과 다른 요일을 이용해 주시길 부탁드립니다.&nbsp;</p> 
        <p><br></p> 
        <p>진료과, 의료진에 대한 상세한 내용은 홈페이지 → 진료안내 → 진료과/의료진,&nbsp;</p> 
        <p>진료예약은 인터넷 진료예약을 이용해 주시면 감사하겠습니다.</p><p></p>
