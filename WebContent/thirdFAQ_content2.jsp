...
<head>
    ...
    <link rel="stylesheet" href="asset/css/thirdFAQ_content2.css">
...
<!--                     <button class="totMenuBtn hideTxt" type="button" aria-controls="totMenu">
        ...
        <main id="content" class="rsvContent replaceUtilMenu">
            ...
            <div class="boardView">
                ...
                <div class="viewTitle">
                    <h3>
                        상병명과 상병코드 등의 내용은 유선상으로 확인이 가능한가요?
                    </h3>
                    ...
                    <div class="date">
                        조회수 : 1969
                        <span class="">작성일 : 2017-10-16</span>
                    </div>
                ...
                <div class="viewContent">
                    ...
                    <p></p><p>환자의 모든 의료정보는 개인정보이기 때문에,본인 확인이 불가능한 유선상으로는 상병명 등의 모든 의료정보는 알려드릴 수 없습니다.<br>
         번거로우시더라도 담당 의사와 진료 시 문의하시거나 진단서 또는 의무기록사본을 발급받아 확인하셔야 합니다.<br></p><p></p>
