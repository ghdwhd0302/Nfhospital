...
<!--                     <button class="totMenuBtn hideTxt" type="button" aria-controls="totMenu">
        ...
        <main id="content" class="cstomerContent replaceUtilMenu">
            ...
            <div class="boxTypeGray boxVtical">
                ...
                <div class="txtWrap">
                    <p>병원을 이용하시면서 불편하셨던 점이나 제안 사항에 대한 의견을 수렴하는 공간입니다.<br>일방적인 욕설, 비방 협박성 글에는 답변드리지 않으며 관리자에 의해 삭제될 수 있습니다.</p>
                    <p>진료과 및 의료진 선택이나 진료일정 문의는 진료 예약센터로 전화해 주십시오.<br><strong class="colorPoint">예약센터 : 1588-5700</strong></p>
                </div>
            </div>
            <form id="joinClientVo" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="btnWrap alignC">
                        <button type="button" class="btnType02 btnBig" id="btnPraiseList" onClick="location.href='myWrite.jsp'">내가 쓴 글 보기</button>
